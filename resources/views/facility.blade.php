                    ...
                    @foreach($cityFacilities as $key => $val)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="javascript:void(0)" data-id="{{ $val->id }}" class="edit btn btn-primary btn-sm editcityfacility">
                                    <i class="fa fa-edit"></i>
                                </a>
                                <a href="javascript:void(0)" data-id="{{ $val->id }}" class="delete btn btn-danger btn-sm deletecityfacility">
